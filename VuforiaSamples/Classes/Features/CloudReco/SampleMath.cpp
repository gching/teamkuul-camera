...
{
    QCAR::Vec2F
    Vec2FSub(QCAR::Vec2F v1, QCAR::Vec2F v2)
    {
        QCAR::Vec2F r;
    ...
    float
    Vec2FDist(QCAR::Vec2F v1, QCAR::Vec2F v2)
    {
    ...
    QCAR::Vec3F
    Vec3FAdd(QCAR::Vec3F v1, QCAR::Vec3F v2)
    {
        QCAR::Vec3F r;
        r.data[0] = v1.data[0] + v2.data[0];
        r.data[1] = v1.data[1] + v2.data[1];
    ...
    QCAR::Vec3F
    Vec3FSub(QCAR::Vec3F v1, QCAR::Vec3F v2)
    {
        QCAR::Vec3F r;
        r.data[0] = v1.data[0] - v2.data[0];
        r.data[1] = v1.data[1] - v2.data[1];
    ...
    QCAR::Vec3F
    Vec3FScale(QCAR::Vec3F v, float s)
    {
        QCAR::Vec3F r;
        r.data[0] = v.data[0] * s;
        r.data[1] = v.data[1] * s;
    ...
    float
    Vec3FDot(QCAR::Vec3F v1, QCAR::Vec3F v2)
    {
    ...
    QCAR::Vec3F
    Vec3FCross(QCAR::Vec3F v1, QCAR::Vec3F v2)
    {
        QCAR::Vec3F r;
    ...
    QCAR::Vec3F
    Vec3FTransform(QCAR::Vec3F& v, QCAR::Matrix44F& m)
    {
        QCAR::Vec3F r;
        float lambda;
    ...
    QCAR::Vec3F
    Vec3FTransformNormal(QCAR::Vec3F& v, QCAR::Matrix44F& m)
    {
        QCAR::Vec3F r;
    ...
    QCAR::Vec4F
    Vec4FTransform(QCAR::Vec4F& v, QCAR::Matrix44F& m)
    {
        QCAR::Vec4F r;
    ...
    QCAR::Matrix44F
    Matrix44FTranspose(QCAR::Matrix44F m)
    {
        QCAR::Matrix44F r;
        for (int i = 0; i < 4; i++)
            for (int j = 0; j < 4; j++)
    ...
    float
    Matrix44FDeterminate(QCAR::Matrix44F& m)
    {
    ...
    QCAR::Matrix44F
    Matrix44FInverse(QCAR::Matrix44F& m)
    {
        QCAR::Matrix44F r;
    ...
    void
    projectScreenPointToPlane(QCAR::Matrix44F inverseProjMatrix, QCAR::Matrix44F modelViewMatrix,
